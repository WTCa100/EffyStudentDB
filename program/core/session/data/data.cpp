...
SessionData::SessionData()
{
    ...
    entryList_.insert(std::make_pair("Schools", std::map<uint16_t, std::shared_ptr<Entry>>()));
    entryList_.insert(std::make_pair("Students", std::map<uint16_t, std::shared_ptr<Entry>>()));
    entryList_.insert(std::make_pair("Subjects", std::map<uint16_t, std::shared_ptr<Entry>>()));
    entryList_.insert(std::make_pair("Courses", std::map<uint16_t, std::shared_ptr<Entry>>()));
    entryList_.insert(std::make_pair("StudentRequest", std::map<uint16_t, std::shared_ptr<Entry>>()));
}
