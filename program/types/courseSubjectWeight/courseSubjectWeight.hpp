...
namespace Core::Types
{
    ...
    struct CourseSubjectWeight : public Entry 
    {
        ...
        CourseSubjectWeight() : Entry(0, g_tableCourseSubjectWeight) {}
        CourseSubjectWeight(uint16_t id, double weight, uint16_t courseId, uint16_t subjectId, std::string courseName = "", std::string subjectName = "");
    };
